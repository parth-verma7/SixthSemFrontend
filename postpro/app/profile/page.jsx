    ...
    return (
        ...
        {session?.user ? (
          ...
          <>
            ...
            <div className="h-[80vh] w-full bg-white-200 overflow-scroll border-2 border-grey-300">
                <div className="md:flex border-4 border-amber-200">
                    ...
                    <div className="p-8 w-full md:w-auto">
                        <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold mb-4"> Ammelia
                            Harper
                        </div>
