import GithubIcon from '/home/pranjaladwani12/next_full_stack/components/GithubIcon.jsx';

const techs = ['next js', 'typescript', 'tailwind css', 'trpc'];

const renderTechs = () => techs.map((t) => <li className="underline underline-offset-2 dark:text-white" key={t}>{t}</li>);

const MainCard = () => (
  <div className="bg-white p-20 shadow-md dark:bg-slate-600">
